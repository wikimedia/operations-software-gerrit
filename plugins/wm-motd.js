class WikimediaMotdElement extends Polymer.Element {
  ...
  static get template() {
    ...
    <div id="banner" class$="[[_computeBannerClass(display)]]">
      Take the
      <a href="https://wikimediafoundation.limesurvey.net/986172">
      2024 Developer Satisfaction Survey
      </a>
      (<a href="https://foundation.wikimedia.org/wiki/Legal:Developer_Satisfaction_Survey_2024_Privacy_Statement">
      privacy statement
  ...
  _itemKey() {
    return 'wm-motd-2024-dev-survey_dismiss';
  }
